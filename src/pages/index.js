...
//       >
//         <img src="/screenshot1.png" alt="Image 1" /> {}
//       </div>
//       <div
//         style={{
//           display: "flex",
...
//         <A placeholder="  Phone number, user name or email" height="38px" />
//         <A placeholder="  Password" height="38px" />
//         <B width="262px" text="Log In" color="white" />
//         <C />
//         <D
//           icon="📘"
//           width="262px"
...
export default function Home() {
  const alertB = (alertText) => {
    alert(alertText);
  };

  return <div>{/* <D alert={alertB} /> */}</div>;
}
